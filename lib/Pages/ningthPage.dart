...
class NiengthPage9 extends StatefulWidget {
  const NiengthPage9({Key? key}) : super(key: key);

  @override
  State<NiengthPage9> createState() => _NiengthPage9State();
}

class _NiengthPage9State extends State<NiengthPage9> {
  @override
              ...
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "2 passenger . Waiting for 2 Others",
                        style: TextStyle(
                            fontSize: 16,
