...
class Seventhpage7 extends StatefulWidget {
  const Seventhpage7({Key? key}) : super(key: key);

  @override
  State<Seventhpage7> createState() => _Seventhpage7State();
}

class _Seventhpage7State extends State<Seventhpage7> {
  @override
